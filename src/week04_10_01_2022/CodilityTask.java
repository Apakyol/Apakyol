...
public class CodilityTask {
      ...
      Write a function:
                ...
                - If a number is divisible by more than one of the
                 ...
                 of the respective words Codility,
                 Test and Coders in this given order.
                                    EXPECTED
                            numbers divisible by both 2 and 3 should be
                            replaced by CodilityTest
        ...
        public static void main(String[] args) {
            ...
            if (number > 0) {  // I can go on with other steps
                // if the number is positve we will check the number divisible
                // by 2 We put the Codility inside variable
                if (number % 2 == 0) {
                    result = "Codility";
                }
                // if the number is positve we will check the number divisible
                // by 3 We append the Test inside variable
                if (number % 3 == 0) {
                    //   result = result + "Test";
                    result+="Test";
                }
                // if the number is positve we will check the number divisible
                // by 5 We append the Coders inside variable
